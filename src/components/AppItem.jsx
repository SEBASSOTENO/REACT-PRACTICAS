...
import '../assets/style/components/appitem.scss';
...
<div class="carousel__container">
      ...
      <div class="carousel-item">
        ...
        <div class="carousel-item__details">
          <div>
          <img class="carousel-item__details--img" src="../assets/static/play-icon.png" alt="Play Icon"></img>
            <img class="carousel-item__details--img" src="../assets/static/plus-icon.png" alt="Plus Icon"></img>
          </div>
    ...
    <h3 class="categories__title">Platzi Sebastián</h3>
